...
__device__ inline real rand_double(curandState* state) {
...
__device__ inline vec3 rand_cosine_direction(curandState* state) {
	real r1  = curand_uniform_double(state);
	real r2  = curand_uniform_double(state);
	real phi = 2.0 * 3.1415926535897932385 * r1;
